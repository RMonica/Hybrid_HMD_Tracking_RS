...
#ifndef DIRECTED_COMPLEMENTARY_TRACKING_H
#define DIRECTED_COMPLEMENTARY_TRACKING_H
...
class DirectedComplementaryTracking : public ITracking
{
  public:

  bool SetParameter(const int parameter_id, const float value) override;

  DirectedComplementaryTracking();
...
#endif // DIRECTED_COMPLEMENTARY_TRACKING_H
